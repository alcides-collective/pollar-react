...
function SidebarNav({ sections, activeSection, scrollToSection }: {
  ...
  return (
    <>
      {/* Mobile navigation */}
      <div className="lg:hidden sticky top-0 z-10 bg-background/80 backdrop-blur-sm border-b border-divider -mx-6 px-6 py-3 mb-8">
            ...
            <button
              ...
              className={`px-3 py-1.5 text-xs rounded-full whitespace-nowrap transition-all ${
                activeSection === s.id
                  ...
                  : 'bg-surface text-content-subtle hover:bg-muted'
              }`}
            >
              {s.title}
            </button>
            ...
            <button
              ...
              className={`group w-full text-left px-4 py-2.5 rounded-lg text-sm transition-all duration-200 flex items-baseline gap-3 ${
                activeSection === s.id
                  ...
                  : 'text-content-faint hover:text-content-heading hover:bg-surface'
              }`}
            >
              <span className={`text-xs tabular-nums ${activeSection === s.id ? 'text-content-faint' : 'text-content-faint group-hover:text-content-faint'}`}>
  ...
  return (
    <>
      <section id="postanowienia" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">1. Postanowienia ogólne</h2>
        <p className="text-content mb-3">Niniejszy Regulamin określa zasady korzystania z serwisu internetowego dostępnego pod adresem <a href="https://pollar.news" className="text-red-600 hover:underline">https://pollar.news</a> (&bdquo;<strong>Serwis</strong>&rdquo;) oraz powiązanych aplikacji mobilnych i telewizyjnych (&bdquo;<strong>Aplikacje</strong>&rdquo;), prowadzonych przez <strong>{COMPANY_INFO}</strong> (&bdquo;<strong>Pollar</strong>&rdquo;, &bdquo;<strong>Usługodawca</strong>&rdquo;).</p>
        <p className="text-content mb-3">Korzystanie z Serwisu i Aplikacji oznacza akceptację niniejszego Regulaminu.</p>
        <p className="text-content">Regulamin jest udostępniany nieodpłatnie za pośrednictwem Serwisu w formie umożliwiającej jego pobranie, utrwalenie i wydrukowanie.</p>
      </section>

      <section id="definicje" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">2. Definicje</h2>
        <ul className="list-disc pl-6 text-content space-y-1.5">
      ...
      <section id="zakres" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">3. Rodzaje i zakres Usług</h2>
        <p className="text-content mb-3">Usługodawca świadczy następujące Usługi:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
        ...
        <p className="text-content">Usługi są świadczone nieodpłatnie, chyba że wyraźnie wskazano inaczej.</p>
      </section>

      <section id="warunki" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">4. Warunki korzystania z Serwisu</h2>
        <p className="text-content mb-3">Do korzystania z Serwisu niezbędne jest:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
        ...
        <p className="text-content">Użytkownik zobowiązuje się do korzystania z Serwisu zgodnie z obowiązującym prawem, niniejszym Regulaminem oraz zasadami współżycia społecznego.</p>
      </section>

      <section id="rejestracja" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">5. Rejestracja i Konto</h2>
        <p className="text-content mb-3">Rejestracja Konta jest dobrowolna. Część funkcjonalności Serwisu dostępna jest bez rejestracji.</p>
        <p className="text-content mb-3">Aby utworzyć Konto, Użytkownik podaje:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
      ...
      <section id="wlasnosc" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">6. Treści i własność intelektualna</h2>
        <p className="text-content mb-3">Serwis agreguje i przetwarza publicznie dostępne artykuły prasowe. Pollar nie jest autorem ani wydawcą oryginalnych artykułów — pełna treść artykułów dostępna jest na stronach ich wydawców.</p>
        <p className="text-content mb-3">Podsumowania i analizy generowane przez sztuczną inteligencję mają charakter informacyjny i nie stanowią porad prawnych, finansowych ani inwestycyjnych.</p>
        <p className="text-content">Elementy graficzne Serwisu, układ treści, logotypy oraz oprogramowanie stanowią własność Usługodawcy lub są wykorzystywane na podstawie odpowiednich licencji i podlegają ochronie prawnej.</p>
      </section>

      <section id="licencja" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">7. Licencja Creative Commons</h2>
        <p className="text-content mb-3">Oryginalne treści publikowane w Serwisie — w tym podsumowania, analizy, artykuły briefów dziennych oraz felietony generowane przez Usługodawcę — udostępniane są na warunkach licencji <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.pl" target="_blank" rel="license noopener noreferrer" className="text-red-600 hover:underline">Creative Commons Uznanie autorstwa – Użycie niekomercyjne – Na tych samych warunkach 4.0 Międzynarodowe (CC BY-NC-SA 4.0)</a>.</p>
        <p className="text-content mb-3">Licencjodawca udziela ogólnoświatowej, nieodpłatnej, niewyłącznej i nieodwołalnej licencji na korzystanie z Treści wyłącznie w celach niekomercyjnych, obejmującej prawo do:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
        ...
        <p className="text-content mb-3">Warunki korzystania:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
        ...
        <p className="text-content mb-3">Licencja nie obejmuje elementów graficznych Serwisu, logotypów, oprogramowania ani treści pochodzących z zewnętrznych źródeł prasowych. Wszelkie ograniczenia wyrażone za pośrednictwem niniejszej licencji stanowią wyraźne zastrzeżenie praw w rozumieniu art. 4 Dyrektywy Parlamentu Europejskiego i Rady (UE) 2019/790 w sprawie prawa autorskiego i praw pokrewnych na jednolitym rynku cyfrowym.</p>
        <p className="text-content">Pełny tekst prawny licencji dostępny jest pod adresem: <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.pl" target="_blank" rel="noopener noreferrer" className="text-red-600 hover:underline">creativecommons.org/licenses/by-nc-sa/4.0/legalcode</a>.</p>
      </section>

      <section id="odpowiedzialnosc" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">8. Odpowiedzialność</h2>
        <p className="text-content mb-3">Usługodawca dokłada wszelkich starań, aby Serwis działał prawidłowo i nieprzerwanie, jednak nie gwarantuje braku przerw technicznych ani błędów.</p>
        <p className="text-content mb-3">Usługodawca nie ponosi odpowiedzialności za:</p>
        <ul className="list-disc pl-6 text-content space-y-1.5">
      ...
      <section id="dane" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">10. Ochrona danych osobowych</h2>
        <p className="text-content">Zasady przetwarzania danych osobowych Użytkowników opisane są w <LocalizedLink to="/polityka-prywatnosci" className="text-red-600 hover:underline">Polityce prywatności</LocalizedLink>.</p>
      </section>

      <section id="zmiany" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">11. Zmiany Regulaminu</h2>
        <p className="text-content mb-3">Usługodawca zastrzega sobie prawo do zmiany niniejszego Regulaminu. O zmianach Użytkownicy posiadający Konto zostaną poinformowani drogą e-mailową z odpowiednim wyprzedzeniem.</p>
        <p className="text-content mb-3">Korzystanie z Serwisu po wejściu w życie zmian oznacza ich akceptację.</p>
        <p className="text-content font-semibold">Ta wersja Regulaminu obowiązuje od: 6 lutego 2026</p>
      </section>

      <section className="mt-12 pt-8 border-t border-divider">
        <div className="bg-surface rounded-xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h3 className="text-lg font-semibold text-content-heading mb-1">Polityka prywatności</h3>
            <p className="text-sm text-content">Dowiedz się, jak przetwarzamy Twoje dane osobowe.</p>
          </div>
          <LocalizedLink to="/polityka-prywatnosci" className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-primary-foreground text-sm font-medium rounded-lg hover:bg-primary/90 transition-colors shrink-0">
  ...
  return (
    <>
      <section id="general" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">1. General Provisions</h2>
        <p className="text-content mb-3">These Terms of Service govern the use of the website available at <a href="https://pollar.news" className="text-red-600 hover:underline">https://pollar.news</a> (the &ldquo;<strong>Website</strong>&rdquo;) and related mobile and TV applications (the &ldquo;<strong>Applications</strong>&rdquo;), operated by <strong>Pollar P.S.A.</strong>, seated in Kraków at ul. Piastowska 46/12, 30-067 Kraków, Poland, entered in the National Court Register maintained by the District Court for Kraków-Śródmieście, 11th Commercial Division, under KRS number 0001194489, NIP: 6772540681 (&ldquo;<strong>Pollar</strong>&rdquo;, the &ldquo;<strong>Provider</strong>&rdquo;).</p>
        <p className="text-content mb-3">By using the Website and Applications you accept these Terms of Service.</p>
        <p className="text-content">These Terms are made available free of charge via the Website in a form that allows downloading, saving and printing.</p>
      </section>

      <section id="definitions" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">2. Definitions</h2>
        <ul className="list-disc pl-6 text-content space-y-1.5">
      ...
      <section id="scope" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">3. Scope of Services</h2>
        <p className="text-content mb-3">The Provider offers the following Services:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
        ...
        <p className="text-content">Services are provided free of charge unless explicitly stated otherwise.</p>
      </section>

      <section id="requirements" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">4. Requirements</h2>
        <p className="text-content mb-3">To use the Website you need:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
        ...
        <p className="text-content">Users agree to use the Website in accordance with applicable law and these Terms.</p>
      </section>

      <section id="registration" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">5. Registration and Account</h2>
        <p className="text-content mb-3">Account registration is voluntary. Some features are available without an Account.</p>
        <p className="text-content mb-3">To create an Account the User provides:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
      ...
      <section id="ip" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">6. Content and Intellectual Property</h2>
        <p className="text-content mb-3">The Website aggregates and processes publicly available press articles. Pollar is not the author or publisher of the original articles — full article text is available on the publishers' websites.</p>
        <p className="text-content mb-3">AI-generated summaries and analyses are informational only and do not constitute legal, financial or investment advice.</p>
        <p className="text-content">Graphics, layout, logos and software are the property of the Provider or are used under appropriate licences and are protected by law.</p>
      </section>

      <section id="license" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">7. Creative Commons License</h2>
        <p className="text-content mb-3">Original content published on the Website — including summaries, analyses, daily brief articles and opinion pieces generated by the Provider — is made available under the terms of the <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.en" target="_blank" rel="license noopener noreferrer" className="text-red-600 hover:underline">Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License (CC BY-NC-SA 4.0)</a>.</p>
        <p className="text-content mb-3">The Licensor hereby grants a worldwide, royalty-free, non-sublicensable, non-exclusive, irrevocable license to exercise rights in the Content for noncommercial purposes only, including the right to:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
        ...
        <p className="text-content mb-3">Terms of use:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
        ...
        <p className="text-content mb-3">This license does not cover the Website's graphics, logos, software or content originating from third-party press sources. Any restrictions expressed via this license constitute express reservations of rights under Article 4 of Directive (EU) 2019/790 of the European Parliament and of the Council on copyright and related rights in the Digital Single Market.</p>
        <p className="text-content">The full legal code of the license is available at: <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.en" target="_blank" rel="noopener noreferrer" className="text-red-600 hover:underline">creativecommons.org/licenses/by-nc-sa/4.0/legalcode</a>.</p>
      </section>

      <section id="liability" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">8. Liability</h2>
        <p className="text-content mb-3">The Provider makes every effort to ensure the Website operates correctly and continuously, but does not guarantee the absence of technical interruptions or errors.</p>
        <p className="text-content mb-3">The Provider is not liable for:</p>
        <ul className="list-disc pl-6 text-content space-y-1.5">
      ...
      <section id="data" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">10. Personal Data</h2>
        <p className="text-content">The rules for processing Users' personal data are described in the <LocalizedLink to="/polityka-prywatnosci" className="text-red-600 hover:underline">Privacy Policy</LocalizedLink>.</p>
      </section>

      <section id="changes" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">11. Changes to the Terms</h2>
        <p className="text-content mb-3">The Provider reserves the right to amend these Terms. Account holders will be notified of changes by email in advance.</p>
        <p className="text-content mb-3">Continued use of the Website after the changes take effect constitutes acceptance.</p>
        <p className="text-content font-semibold">This version of the Terms is effective from: 6 February 2026</p>
      </section>

      <section className="mt-12 pt-8 border-t border-divider">
        <div className="bg-surface rounded-xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h3 className="text-lg font-semibold text-content-heading mb-1">Privacy Policy</h3>
            <p className="text-sm text-content">Learn how we process your personal data.</p>
          </div>
          <LocalizedLink to="/polityka-prywatnosci" className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-primary-foreground text-sm font-medium rounded-lg hover:bg-primary/90 transition-colors shrink-0">
            Privacy Policy
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
  ...
  return (
    <>
      ...
      <section id="umfang" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">3. Umfang der Dienste</h2>
        <p className="text-content mb-3">Der Anbieter bietet folgende Dienste an:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
        ...
        <p className="text-content">Die Dienste werden kostenlos erbracht, sofern nicht ausdrücklich anders angegeben.</p>
      </section>

      <section id="voraussetzungen" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">4. Voraussetzungen</h2>
        <p className="text-content mb-3">Zur Nutzung der Website benötigen Sie:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
        ...
        <p className="text-content">Die Nutzer verpflichten sich, die Website im Einklang mit geltendem Recht und diesen Bedingungen zu nutzen.</p>
      </section>

      <section id="registrierung" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">5. Registrierung und Konto</h2>
        <p className="text-content mb-3">Die Kontoregistrierung ist freiwillig. Einige Funktionen sind ohne Konto verfügbar.</p>
        <p className="text-content mb-3">Zur Kontoerstellung gibt der Nutzer an:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
      ...
      <section id="eigentum" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">6. Inhalte und geistiges Eigentum</h2>
        <p className="text-content mb-3">Die Website aggregiert und verarbeitet öffentlich zugängliche Presseartikel. Pollar ist nicht Autor oder Herausgeber der Originalartikel — der vollständige Artikeltext ist auf den Websites der Herausgeber verfügbar.</p>
        <p className="text-content mb-3">KI-generierte Zusammenfassungen und Analysen dienen ausschließlich Informationszwecken und stellen keine Rechts-, Finanz- oder Anlageberatung dar.</p>
        <p className="text-content">Grafiken, Layout, Logos und Software sind Eigentum des Anbieters oder werden unter entsprechenden Lizenzen verwendet und sind gesetzlich geschützt.</p>
      </section>

      <section id="lizenz" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">7. Creative-Commons-Lizenz</h2>
        <p className="text-content mb-3">Originale Inhalte, die auf der Website veröffentlicht werden — einschließlich Zusammenfassungen, Analysen, täglicher Briefings und Kolumnen, die vom Anbieter erstellt werden — werden unter den Bedingungen der <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.de" target="_blank" rel="license noopener noreferrer" className="text-red-600 hover:underline">Creative Commons Namensnennung – Nicht kommerziell – Weitergabe unter gleichen Bedingungen 4.0 International Lizenz (CC BY-NC-SA 4.0)</a> bereitgestellt.</p>
        <p className="text-content mb-3">Der Lizenzgeber gewährt eine weltweite, gebührenfreie, nicht unterlizenzierbare, nicht-exklusive und unwiderrufliche Lizenz zur Nutzung der Inhalte ausschließlich zu nicht-kommerziellen Zwecken, einschließlich des Rechts:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
        ...
        <p className="text-content mb-3">Nutzungsbedingungen:</p>
        <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
        ...
        <p className="text-content mb-3">Diese Lizenz erstreckt sich nicht auf Grafiken, Logos, Software oder Inhalte aus externen Pressequellen der Website. Sämtliche über diese Lizenz ausgedrückten Einschränkungen stellen ausdrückliche Rechtevorbehalte im Sinne von Art. 4 der Richtlinie (EU) 2019/790 des Europäischen Parlaments und des Rates über das Urheberrecht und die verwandten Schutzrechte im digitalen Binnenmarkt dar.</p>
        <p className="text-content">Der vollständige Lizenztext ist verfügbar unter: <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.de" target="_blank" rel="noopener noreferrer" className="text-red-600 hover:underline">creativecommons.org/licenses/by-nc-sa/4.0/legalcode</a>.</p>
      </section>

      <section id="haftung" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">8. Haftung</h2>
        <p className="text-content mb-3">Der Anbieter bemüht sich nach besten Kräften, den ordnungsgemäßen und kontinuierlichen Betrieb der Website sicherzustellen, garantiert jedoch nicht das Ausbleiben technischer Unterbrechungen oder Fehler.</p>
        <p className="text-content mb-3">Der Anbieter haftet nicht für:</p>
        <ul className="list-disc pl-6 text-content space-y-1.5">
      ...
      <section id="daten" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">10. Personenbezogene Daten</h2>
        <p className="text-content">Die Regeln zur Verarbeitung personenbezogener Daten der Nutzer sind in der <LocalizedLink to="/polityka-prywatnosci" className="text-red-600 hover:underline">Datenschutzrichtlinie</LocalizedLink> beschrieben.</p>
      </section>

      <section id="aenderungen" className="mb-14 scroll-mt-24">
        <h2 className="text-xl font-semibold mb-4 text-content-heading">11. Änderungen der Bedingungen</h2>
        <p className="text-content mb-3">Der Anbieter behält sich das Recht vor, diese Bedingungen zu ändern. Kontoinhaber werden vorab per E-Mail über Änderungen informiert.</p>
        <p className="text-content mb-3">Die weitere Nutzung der Website nach Inkrafttreten der Änderungen gilt als Zustimmung.</p>
        <p className="text-content font-semibold">Diese Fassung der Bedingungen gilt ab: 6. Februar 2026</p>
      </section>

      <section className="mt-12 pt-8 border-t border-divider">
        <div className="bg-surface rounded-xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h3 className="text-lg font-semibold text-content-heading mb-1">Datenschutzrichtlinie</h3>
            <p className="text-sm text-content">Erfahren Sie, wie wir Ihre personenbezogenen Daten verarbeiten.</p>
          </div>
          <LocalizedLink to="/polityka-prywatnosci" className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-primary-foreground text-sm font-medium rounded-lg hover:bg-primary/90 transition-colors shrink-0">
...
export function TermsOfServicePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      {/* Hero */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold mb-6 text-content-heading">{TITLE[language] || TITLE.pl}</h1>
        <GrainImage
          src={termsImg}
