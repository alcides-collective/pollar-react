...
const featureKeys = [
  { key: 'brief', icon: 'ri-calendar-todo-line', href: '/brief', color: 'bg-amber-50 text-amber-600' },
  { key: 'assistant', icon: 'ri-robot-2-line', href: '/asystent', color: 'bg-violet-50 text-violet-600' },
  { key: 'sejm', icon: 'ri-government-line', href: '/sejm', color: 'bg-red-50 text-red-600' },
  { key: 'stock', icon: 'ri-stock-line', href: '/gielda', color: 'bg-emerald-50 text-emerald-600' },
  { key: 'data', icon: 'ri-bar-chart-box-line', href: '/dane', color: 'bg-blue-50 text-blue-600' },
  { key: 'connections', icon: 'ri-gamepad-line', href: '/powiazania', color: 'bg-pink-50 text-pink-600' },
  { key: 'map', icon: 'ri-map-pin-line', href: '/mapa', color: 'bg-cyan-50 text-cyan-600' },
  { key: 'terminal', icon: 'ri-terminal-line', href: '/terminal', color: 'bg-zinc-100 text-zinc-700' },
  { key: 'archive', icon: 'ri-archive-line', href: '/archiwum', color: 'bg-orange-50 text-orange-600' },
] as const;
