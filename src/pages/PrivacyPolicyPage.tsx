...
export function PrivacyPolicyPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      {/* Hero */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold mb-6 text-content-heading">{t('title')}</h1>
        <GrainImage
          src={privacyImg}
          alt={t('imageAlt')}
      ...
      <div className="max-w-3xl mb-12 text-[15px] leading-relaxed">
        <p className="text-content mb-3">{t('intro.p1')}</p>
        ...
        <p className="text-content">{t('intro.p3')}</p>
      </div>
      ...
      <div className="flex gap-10 lg:gap-16">
        ...
        <div ref={contentRef} className="flex-1 min-w-0 text-[15px] leading-relaxed">
          ...
          <section id="s1" className="mb-14 scroll-mt-24">
            <h2 className="text-xl font-semibold mb-4 text-content-heading">{t('s1.title')}</h2>
            <p className="text-content mb-3">
              <Trans i18nKey="s1.p1" ns="privacy" components={{ bold }} />
            </p>
            <p className="text-content mb-3">{t('s1.p2')}</p>
          ...
          <section id="s2" className="mb-14 scroll-mt-24">
            <h2 className="text-xl font-semibold mb-4 text-content-heading">{t('s2.title')}</h2>
            <p className="text-content mb-3">
          ...
          <section id="s3" className="mb-14 scroll-mt-24">
            <h2 className="text-xl font-semibold mb-4 text-content-heading">{t('s3.title')}</h2>
            <p className="text-content mb-4">{t('s3.p1')}</p>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s3.website.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
              <li>{t('s3.website.item1')}</li>
              <li>{t('s3.website.item2')}</li>
              <li>{t('s3.website.item3')}</li>
            </ul>
            <p className="text-content-subtle italic mb-4">{t('s3.website.note')}</p>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s3.apps.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
            ...
            <p className="text-content-subtle italic mb-4">{t('s3.apps.note')}</p>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s3.newsletter.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
              <li>{t('s3.newsletter.item1')}</li>
            </ul>
            <p className="text-content-subtle italic mb-4">{t('s3.newsletter.note')}</p>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s3.social.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
              <li>{t('s3.social.item1')}</li>
              <li>{t('s3.social.item2')}</li>
            </ul>
            <p className="text-content-subtle italic mb-4">{t('s3.social.note')}</p>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s3.author.title')}</h3>
          ...
          <section id="s4" className="mb-14 scroll-mt-24">
            <h2 className="text-xl font-semibold mb-4 text-content-heading">{t('s4.title')}</h2>
            <p className="text-content mb-4">{t('s4.p1')}</p>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s4.website.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-4">
              <li>{t('s4.website.item1')}</li>
            </ul>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s4.apps.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-4 space-y-1.5">
              <li><Trans i18nKey="s4.apps.item1" ns="privacy" components={{ bold }} /></li>
              <li><Trans i18nKey="s4.apps.item2" ns="privacy" components={{ bold }} /></li>
            </ul>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s4.newsletter.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-4">
              <li>{t('s4.newsletter.item1')}</li>
            </ul>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s4.social.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-4">
              <li>{t('s4.social.item1')}</li>
            </ul>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s4.author.title')}</h3>
            <ul className="list-disc pl-6 text-content">
          ...
          <section id="s5" className="mb-14 scroll-mt-24">
            <h2 className="text-xl font-semibold mb-4 text-content-heading">{t('s5.title')}</h2>
            <p className="text-content mb-4">{t('s5.p1')}</p>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s5.website.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-4 space-y-1.5">
              <li>{t('s5.website.item1')}</li>
              <li>{t('s5.website.item2')}</li>
            </ul>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s5.apps.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-4 space-y-1.5">
            ...
            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s5.newsletter.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-4">
              <li>{t('s5.newsletter.item1')}</li>
            </ul>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s5.social.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-4 space-y-1.5">
              <li>{t('s5.social.item1')}</li>
              <li>{t('s5.social.item2')}</li>
            </ul>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s5.author.title')}</h3>
            <ul className="list-disc pl-6 text-content">
          ...
          <section id="s6" className="mb-14 scroll-mt-24">
            <h2 className="text-xl font-semibold mb-4 text-content-heading">{t('s6.title')}</h2>
            <p className="text-content mb-4">{t('s6.p1')}</p>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s6.website.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-4">
              <li>{t('s6.website.item1')}</li>
            </ul>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s6.newsletter.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-4">
              <li>{t('s6.newsletter.item1')}</li>
            </ul>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s6.social.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-4">
              <li>{t('s6.social.item1')}</li>
            </ul>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s6.author.title')}</h3>
            <ul className="list-disc pl-6 text-content mb-4">
            ...
            <p className="text-content">{t('s6.transfers')}</p>
          </section>

          {/* Section 7 */}
          <section id="s7" className="mb-14 scroll-mt-24">
            <h2 className="text-xl font-semibold mb-4 text-content-heading">{t('s7.title')}</h2>
            <p className="text-content mb-3">{t('s7.p1')}</p>
            <ul className="list-disc pl-6 text-content mb-3 space-y-1.5">
          ...
          <section id="s8" className="mb-14 scroll-mt-24">
            <h2 className="text-xl font-semibold mb-4 text-content-heading">{t('s8.title')}</h2>
            <p className="text-content mb-4">{t('s8.p1')}</p>

            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s8.fbStats.title')}</h3>
            <p className="text-content mb-3">{t('s8.fbStats.p1')}</p>
            <ul className="list-disc pl-6 text-content mb-4 space-y-1">
            ...
            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s8.ga.title')}</h3>
            ...
            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s8.gads.title')}</h3>
            <p className="text-content mb-4">
            ...
            <h3 className="font-semibold mt-6 mb-3 text-content-heading">{t('s8.fbPixel.title')}</h3>
            <p className="text-content mb-4">
          ...
          <section id="s9" className="mb-14 scroll-mt-24">
            <h2 className="text-xl font-semibold mb-4 text-content-heading">{t('s9.title')}</h2>
            <p className="text-content mb-3">{t('s9.p1')}</p>
            <ul className="list-disc pl-6 text-content space-y-1">
          ...
          <section id="s10" className="mb-14 scroll-mt-24">
            <h2 className="text-xl font-semibold mb-4 text-content-heading">{t('s10.title')}</h2>
            <p className="text-content mb-3">{t('s10.p1')}</p>
            <p className="text-content mb-3">{t('s10.p2')}</p>
            <p className="text-content mb-3">{t('s10.p3')}</p>
            <p className="text-content mb-3">
              <Trans i18nKey="s10.p4" ns="privacy" components={{ bold }} />
            </p>
            <p className="text-content mb-4">{t('s10.p5')}</p>

            <div className="overflow-x-auto rounded-lg border border-divider">
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="bg-surface">
                    <th className="border-b border-divider px-3 py-2.5 text-left font-semibold text-content-heading">{t('s10.tableHeaders.name')}</th>
                    <th className="border-b border-divider px-3 py-2.5 text-left font-semibold text-content-heading">{t('s10.tableHeaders.domain')}</th>
                    <th className="border-b border-divider px-3 py-2.5 text-left font-semibold text-content-heading">{t('s10.tableHeaders.description')}</th>
                    <th className="border-b border-divider px-3 py-2.5 text-left font-semibold text-content-heading">{t('s10.tableHeaders.retention')}</th>
                    <th className="border-b border-divider px-3 py-2.5 text-left font-semibold text-content-heading">{t('s10.tableHeaders.technology')}</th>
                    <th className="border-b border-divider px-3 py-2.5 text-left font-semibold text-content-heading">{t('s10.tableHeaders.type')}</th>
                  </tr>
                </thead>
          ...
          <section id="s11" className="mb-14 scroll-mt-24">
            <h2 className="text-xl font-semibold mb-4 text-content-heading">{t('s11.title')}</h2>
            <p className="text-content mb-3">{t('s11.p1')}</p>
            <p className="text-content mb-3">{t('s11.p2')}</p>
            <p className="text-content font-semibold">{t('s11.effectiveDate')}</p>
          </section>
          ...
          <section className="mt-12 pt-8 border-t border-divider">
            <div className="bg-surface rounded-xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h3 className="text-lg font-semibold text-content-heading mb-1">{t('cookieSettingsFooter.title')}</h3>
                <p className="text-sm text-content">{t('cookieSettingsFooter.description')}</p>
              </div>
              <LocalizedLink
                to="/cookies"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-primary-foreground text-sm font-medium rounded-lg hover:bg-primary/90 transition-colors shrink-0"
              >
...
function CookieRow({ name, domain, cookieKey, t, tech }: CookieRowProps) {
  return (
    <tr className="border-b border-divider-subtle last:border-0">
