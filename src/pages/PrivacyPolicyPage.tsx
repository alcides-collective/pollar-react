  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      <article className="prose prose-zinc max-w-none">
        <h1 className="text-3xl font-bold mb-6">Polityka prywatności POLLAR P.S.A.</h1>

        <p className="text-zinc-600 mb-8">
          W Pollar szanujemy Twoją prywatność. Chcemy, abyś wiedział, w jaki sposób gromadzimy
          Twoje dane, dlaczego są nam potrzebne i jakie prawa Ci przysługują. Ta Polityka wyjaśnia,
          jak korzystamy z Twoich danych i jak możesz sprawować nad nimi kontrolę.
        </p>

        <p className="text-zinc-600 mb-8">
          Ta Polityka opisuje zasady przetwarzania danych na naszej stronie internetowej{' '}
          <a href="https://pollar.pl" className="text-red-600 hover:underline">https://pollar.pl</a>{' '}
          („<strong>Strona Internetowa</strong>") oraz aplikacji web, mobilnych i TV („<strong>Aplikacje</strong>").
        </p>

        <p className="text-zinc-600 mb-8">
          Dokument został przygotowany w języku polskim z myślą o użytkownikach w Polsce.
        </p>

        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">1. Kim jesteśmy?</h2>
          <p className="text-zinc-600 mb-4">
            Administratorem Twoich danych osobowych jest <strong>Pollar P.S.A.</strong> z siedzibą
            w Krakowie przy ul. Piastowskiej 46/12, 30-067 Kraków, zarejestrowaną w rejestrze
            przedsiębiorców Krajowego Rejestru Sądowego prowadzonym przez Sąd Rejonowy dla
            Krakowa - Śródmieścia w Krakowie, XI Wydział Gospodarczy KRS, pod numerem KRS 00011944689,
            o numerze NIP: 6772540681 („<strong>Pollar</strong>", „<strong>my</strong>", „<strong>nas</strong>").
          </p>
          <p className="text-zinc-600 mb-4">
            Jesteśmy twórcami Pollar – agregatora wiadomości, który wykorzystuje sztuczną inteligencję
            do grupowania i podsumowywania artykułów prasowych. W związku z tym przetwarzamy dane osób, które:
          </p>
          ...
          <p className="text-zinc-600">
            ...
            pod adresem e-mail: <strong>jakub@pollar.pl</strong>, z dopiskiem „<strong>RODO</strong>".
          </p>
        </section>

        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">2. Skąd otrzymujemy Twoje dane?</h2>
          <p className="text-zinc-600 mb-4">
            Co do zasady dane, które przetwarzamy, przekazujesz nam <strong>bezpośrednio</strong>.
          ...
          <p className="text-zinc-600 mb-4">
            Dane, które otrzymujemy <strong>pośrednio</strong>, to dane, które otrzymujemy w sytuacji, gdy:
          </p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">3. Cele i podstawy przetwarzania Twoich danych osobowych</h2>
          <p className="text-zinc-600 mb-4">
            W zależności od tego, w jaki sposób korzystasz z naszej Strony Internetowej i Aplikacji,
            możemy przetwarzać Twoje dane w różnych celach. Poniżej znajdziesz najważniejsze z nich:
          </p>

          <h3 className="font-semibold mt-6 mb-3">Odwiedzasz naszą Stronę Internetową:</h3>
          <ul className="list-disc pl-6 text-zinc-600 mb-4 space-y-2">
          ...
          <p className="text-zinc-500 italic mb-6">
            Dzięki tym danym strona działa płynnie i możemy ją rozwijać zgodnie z Twoimi potrzebami.
          </p>

          <h3 className="font-semibold mt-6 mb-3">Korzystasz z naszych Aplikacji:</h3>
          <ul className="list-disc pl-6 text-zinc-600 mb-4 space-y-2">
          ...
          <p className="text-zinc-500 italic mb-6">
            Bez tych danych nie moglibyśmy zapewnić Ci dostępu do konta ani zagwarantować bezpieczeństwa naszej usługi.
          </p>

          <h3 className="font-semibold mt-6 mb-3">Zapisujesz się do naszego newslettera lub na listę oczekujących:</h3>
          <ul className="list-disc pl-6 text-zinc-600 mb-4 space-y-2">
          ...
          <p className="text-zinc-500 italic mb-6">
            Dzięki temu będziesz na bieżąco z nowościami w Pollar.
          </p>

          <h3 className="font-semibold mt-6 mb-3">Odwiedzasz nasze profile w mediach społecznościowych:</h3>
          <ul className="list-disc pl-6 text-zinc-600 mb-4 space-y-2">
          ...
          <p className="text-zinc-500 italic mb-6">
            Dane te wykorzystujemy, by móc odpowiedzieć Ci na komentarze lub wiadomości.
          </p>

          <h3 className="font-semibold mt-6 mb-3">Jesteś twórcą artykułów, które analizujemy w ramach naszych usług:</h3>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">4. Jakie dane przetwarzamy?</h2>
          <p className="text-zinc-600 mb-4">
            Zakres danych, które od Ciebie zbieramy, zależy od tego, w jaki sposób korzystasz
            z naszej Strony Internetowej i usług:
          </p>

          <h3 className="font-semibold mt-6 mb-3">Jeśli odwiedzasz naszą Stronę Internetową:</h3>
          ...
          <h3 className="font-semibold mt-6 mb-3">Jeśli korzystasz z naszych Aplikacji:</h3>
          <ul className="list-disc pl-6 text-zinc-600 mb-4 space-y-2">
          ...
          <h3 className="font-semibold mt-6 mb-3">Jeśli zapisujesz się do naszego newslettera lub na listę oczekujących:</h3>
          <ul className="list-disc pl-6 text-zinc-600 mb-4">
            <li>adres e-mail.</li>
          </ul>

          <h3 className="font-semibold mt-6 mb-3">Jeśli odwiedzasz nasze profile w mediach społecznościowych:</h3>
          <ul className="list-disc pl-6 text-zinc-600 mb-4">
          ...
          <h3 className="font-semibold mt-6 mb-3">Jeśli jesteś twórcą artykułów, które analizujemy w ramach naszych usług:</h3>
          <ul className="list-disc pl-6 text-zinc-600">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">5. Jak długo przechowujemy Twoje dane?</h2>
          <p className="text-zinc-600 mb-4">
            Przechowujemy Twoje dane tylko tak długo, jak to naprawdę potrzebne – zgodnie z celem
            ich przetwarzania i przepisami prawa. W przypadku, gdy:
          </p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">6. Komu możemy ujawnić dane osobowe?</h2>
          <p className="text-zinc-600 mb-4">
            Twoje dane możemy przekazywać zaufanym partnerom i dostawcom, którzy pomagają nam
            świadczyć nasze usługi. W zależności od tego, jak korzystasz z usług Pollar,
            Twoje dane mogą trafić do następujących kategorii odbiorców:
          </p>

          <h3 className="font-semibold mt-6 mb-3">Odwiedzasz naszą Stronę Internetową lub korzystasz z Aplikacji:</h3>
          <ul className="list-disc pl-6 text-zinc-600 mb-4">
          ...
          <h3 className="font-semibold mt-6 mb-3">Jesteś twórcą artykułów, które analizujemy:</h3>
          <ul className="list-disc pl-6 text-zinc-600 mb-4">
          ...
          <p className="text-zinc-600 mb-4">
            <strong>Nigdy nie przekazujemy danych osobowych naszych zarejestrowanych użytkowników
            (takich jak adres e-mail) do dostawców modeli AI.</strong>
          </p>

          <p className="text-zinc-600">
            Twoje dane mogą być przekazywane poza Europejski Obszar Gospodarczy (EOG), ponieważ
            niektórzy z naszych dostawców (np. Google, OpenAI, Railway Corp) mają siedzibę w
            Stanach Zjednoczonych. W takich sytuacjach zawsze stosujemy zabezpieczenia wymagane
            przez RODO, w szczególności standardowe klauzule umowne zatwierdzone przez Komisję
            Europejską (art. 46 ust. 2 lit. c RODO), aby zapewnić Twoim danym odpowiedni poziom ochrony.
          </p>
        </section>

        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">7. Jakie przysługują Ci prawa w związku z przetwarzaniem danych?</h2>
          <p className="text-zinc-600 mb-4">
            Masz pełną kontrolę nad swoimi danymi. Zgodnie z RODO możesz:
          </p>
          <ul className="list-disc pl-6 text-zinc-600 mb-4 space-y-2">
          ...
          <p className="text-zinc-600">
            Aby skorzystać ze swoich praw, możesz skontaktować się z nami pod adresem{' '}
            <strong>jakub@pollar.pl</strong>, z dopiskiem „<strong>RODO</strong>".
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-zinc-600 mb-4">
            Na naszej Stronie Internetowej oraz w ramach naszych profili w mediach społecznościowych
            możemy korzystać z narzędzi analitycznych i reklamowych, które pomagają nam lepiej
            rozumieć potrzeby użytkowników i skuteczniej prowadzić działania marketingowe.
            Poniżej znajdziesz podstawowe informacje o tych rozwiązaniach. Szczegóły zawsze są
            dostępne w politykach prywatności dostawców poszczególnych narzędzi.
          </p>

          <h3 className="font-semibold mt-6 mb-3">Statystyki stron Facebook i Instagram</h3>
          <p className="text-zinc-600 mb-4">
            Meta udostępnia nam zagregowane dane statystyczne dotyczące odwiedzin naszych profili.
            Dzięki temu możemy zobaczyć, jak użytkownicy wchodzą w interakcje z naszymi treściami.
            W tym zakresie działamy jako współadministrator danych razem z Meta Ireland Limited.
          </p>
          ...
          <h3 className="font-semibold mt-6 mb-3">Google Analytics</h3>
          <p className="text-zinc-600 mb-4">
            Korzystamy z Google Analytics, aby badać, w jaki sposób użytkownicy korzystają ze
            Strony Internetowej. Narzędzie to zbiera informacje przy pomocy plików cookies i
            pozwala nam analizować ruch oraz ulepszać treści. Dane przetwarzane przez Google
            nie służą do identyfikacji konkretnych osób.{' '}
            <a href="https://policies.google.com/technologies/partner-sites?hl=pl" className="text-red-600 hover:underline">Więcej informacji</a>.
          </p>

          <h3 className="font-semibold mt-6 mb-3">Google Ads</h3>
          <p className="text-zinc-600 mb-4">
            Google Ads pozwala nam mierzyć skuteczność naszych kampanii reklamowych oraz wyświetlać
            treści promocyjne osobom, które odwiedziły wcześniej Stronę Internetową. Narzędzie
            wykorzystuje cookies i inne technologie śledzące w celu dopasowania reklam.{' '}
            <a href="https://policies.google.com/technologies/ads?hl=pl" className="text-red-600 hover:underline">Szczegółowe informacje</a>.
          </p>

          <h3 className="font-semibold mt-6 mb-3">Facebook Pixel</h3>
          <p className="text-zinc-600 mb-4">
            Na naszej Stronie Internetowej możemy korzystać z Facebook Pixel. To narzędzie,
            które pozwala nam sprawdzać, jak użytkownicy reagują na nasze treści i reklamy
            w mediach społecznościowych, a także lepiej dopasowywać przyszłe kampanie.{' '}
            <a href="https://pl-pl.facebook.com/help/443357099140264?helpref=about_content" className="text-red-600 hover:underline">Szczegóły</a>.
          </p>

          <h3 className="font-semibold mt-6 mb-3">Facebook Ads</h3>
          <p className="text-zinc-600">
            Facebook Ads to rozwiązanie oferowane przez Meta, które umożliwia tworzenie i
            prowadzenie kampanii reklamowych na Facebooku, Instagramie i innych usługach Meta.
            Umożliwia nam kierowanie reklam do wybranych grup odbiorców na podstawie danych
            demograficznych, zainteresowań i zachowań.{' '}
            <a href="https://www.facebook.com/privacy/policy" className="text-red-600 hover:underline">Więcej informacji</a>.
          </p>
        </section>

        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">9. Social Media</h2>
          <p className="text-zinc-600 mb-4">
            Przetwarzamy dane osobowe użytkowników, którzy śledzą nasze profile w mediach
            społecznościowych takich jak Facebook, Instagram, YouTube i TikTok oraz wchodzą
            z nimi w interakcje. Szczegółowe informacje na temat przetwarzania danych przez
            poszczególne portale znajdziesz pod poniższymi linkami:
          </p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">10. Pliki cookies</h2>
          <p className="text-zinc-600 mb-4">
            Na naszej Stronie Internetowej korzystamy z plików cookies oraz podobnych technologii.
            Dzięki nim strona działa prawidłowo, możemy zapewnić bezpieczeństwo, analizować
            statystyki odwiedzin oraz prowadzić działania marketingowe.
          </p>
          <p className="text-zinc-600 mb-4">
            Pliki cookies mogą być zapisywane na Twoim urządzeniu przez nas (tzw. cookies własne)
            albo przez naszych partnerów (tzw. cookies podmiotów trzecich, np. YouTube, Facebook, HubSpot).
          </p>
          <p className="text-zinc-600 mb-6">
            Niektóre cookies są niezbędne do działania strony i nie można ich wyłączyć, inne
            wymagają Twojej zgody – możesz nimi zarządzać w ustawieniach przeglądarki lub w
            banerze cookies widocznym przy pierwszej wizycie.
          </p>
          <p className="text-zinc-600 mb-4">
            Poniżej znajdziesz listę plików cookies, z których korzystamy, wraz z informacją
            o ich przeznaczeniu, czasie przechowywania i rodzaju:
          </p>
            ...
            <table className="w-full text-sm border-collapse border border-zinc-300">
              <thead>
                <tr className="bg-zinc-100">
                  <th className="border border-zinc-300 px-3 py-2 text-left font-semibold">Nazwa</th>
                  <th className="border border-zinc-300 px-3 py-2 text-left font-semibold">Domena</th>
                  <th className="border border-zinc-300 px-3 py-2 text-left font-semibold">Opis</th>
                  <th className="border border-zinc-300 px-3 py-2 text-left font-semibold">Okres przechowywania</th>
                  <th className="border border-zinc-300 px-3 py-2 text-left font-semibold">Rodzaj</th>
                </tr>
              </thead>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4">11. Zmiany w Polityce prywatności</h2>
          <p className="text-zinc-600 mb-4">
            Chcemy, aby nasze zasady dotyczące ochrony danych były przejrzyste i dopasowane do
            tego, jak faktycznie korzystasz ze Strony Internetowej. Dlatego ta Polityka może
            być co jakiś czas aktualizowana.
          </p>
          <p className="text-zinc-600 mb-4">
            Zawsze najnowsza wersja dokumentu będzie dostępna na tej stronie, razem z datą,
            od której obowiązuje.
          </p>
          <p className="text-zinc-600 font-semibold">
            Ta wersja Polityki obowiązuje od: 7 października 2025
          </p>
        </section>
      </article>
    </div>
