...
export const PAGE_FAQS = {
  '/kontakt': {
    pl: [
      { question: 'Jak zgłosić błąd?', answer: 'Najszybciej przez formularz kontaktowy — wybierz temat "Błąd / Bug report" i opisz problem. Możesz też napisać bezpośrednio na jakubdudek@pollar.news.' },
      { question: 'Jak usunąć konto?', answer: 'Napisz do nas z adresu email powiązanego z kontem na jakubdudek@pollar.news z prośbą o usunięcie konta. Usuniemy je w ciągu 7 dni roboczych.' },
    ...
    en: [
      { question: 'How do I report a bug?', answer: 'The quickest way is through the contact form — select "Bug report" as the subject and describe the issue. You can also email jakubdudek@pollar.news directly.' },
      { question: 'How do I delete my account?', answer: 'Email us from the address associated with your account at jakubdudek@pollar.news requesting account deletion. We\'ll delete it within 7 business days.' },
    ...
    de: [
      { question: 'Wie melde ich einen Fehler?', answer: 'Am schnellsten über das Kontaktformular — wählen Sie "Fehler / Bug report" als Betreff und beschreiben Sie das Problem. Sie können auch direkt an jakubdudek@pollar.news schreiben.' },
      { question: 'Wie lösche ich mein Konto?', answer: 'Schreiben Sie uns von der mit Ihrem Konto verknüpften E-Mail-Adresse an jakubdudek@pollar.news mit der Bitte um Kontolöschung. Wir löschen es innerhalb von 7 Werktagen.' },
  ...
  '/info': {
    pl: [
      ...
      { question: 'Kto stoi za Pollar?', answer: 'Pollar P.S.A. to firma zarejestrowana w Krakowie. Zespół tworzą Jakub Dudek (Developer), Bartosz Kasprzycki (Product & Marketing) i Ignacy Nowina Konopka (B2B & Biznes).' },
    ...
    en: [
      ...
      { question: 'Who is behind Pollar?', answer: 'Pollar P.S.A. is a company registered in Kraków, Poland. The team consists of Jakub Dudek (Developer), Bartosz Kasprzycki (Product & Marketing), and Ignacy Nowina Konopka (B2B & Business).' },
    ...
    de: [
      ...
      { question: 'Wer steht hinter Pollar?', answer: 'Pollar P.S.A. ist ein in Kraków, Polen, registriertes Unternehmen. Das Team besteht aus Jakub Dudek (Entwickler), Bartosz Kasprzycki (Produkt & Marketing) und Ignacy Nowina Konopka (B2B & Business).' },
